...
// RegisterAXSJSONEncoder registers a special jsonEncoder under "zyb-json" name.
func RegisterAXSJSONEncoder() error {
	return zap.RegisterEncoder("zyb-json", func(cfg zapcore.EncoderConfig) (zapcore.Encoder, error) {
		return NewAXSJSONEncoder(cfg), nil
	})
}
...
func NewAXSJSONEncoder(cfg zapcore.EncoderConfig) zapcore.Encoder {
